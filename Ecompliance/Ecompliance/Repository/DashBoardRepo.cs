...
namespace Ecompliance.Repository
{
    public class DashBoardRepo
    {
        public DataTable GetDashBoardHomeCount(int UID)
        {
            ...
            try
            {
                ...
                dt = DataLib.ExecuteDataTable("[GetClientDashboard_01092017_1_1]", CommandType.StoredProcedure, parameters); //GetClientDashboard
        ...
        public DataTable GetDashBoardHomeCount(int UID, string CompanyID, string SMonth, string SYear, string TMonth, string TYear)
        {
            ...
            try
            {
                ...
                dt = DataLib.ExecuteDataTable("[GetClientDashboard_17042019_1_1]", CommandType.StoredProcedure, parameters); //GetClientDashboard_01092017_1_1 GetClientDashboard
                //[GetClientDashboard]
                return dt;
            }
        ...
        public static DataTable GetMappedCompany(int UID)
        {
            try
            {
                ...
                return DataLib.ExecuteDataTable("GetMappedCompany00", CommandType.StoredProcedure, p);
            }
            catch { throw; }
        }
        ...
        public ecompdashboard1cl GetDashBoardActWise(string CompanyID, string SMonth, string SYear, string TMonth, string TYear, int UID=0)
        {
    ...
    {
        public List<ecompseries1cl> series1 { get; set; }
