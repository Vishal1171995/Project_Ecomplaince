...
function FilterData(Site, Role) {
    ...
    var Obj = AverageDataSet.filter(function (item) {
        return item.Site == Site && item.AuditStatus == Role;
        ...
        success: function (data) {
            if (data.IsSuccess == true) {
                ...
                $("#grid").kendoGrid({
                    ...
                    columns: [
                        { field: "Company", hidden: true, title: "Company", groupHeaderTemplate: "# if( aggregates.Percentage.average == null ) {# #=value #  : (Average : -)#} else {# #=value #  : (Average : #=kendo.format('{0:n}',aggregates.Percentage.average)#%)#} #" },
                        //{ field: "Site", hidden: true, title: "Site", groupHeaderTemplate: "# if( aggregates.Percentage.average == null ) {# #=value #  : (Average : -)#} else {# #=value #  : (Average : #=kendo.format('{0:n}',aggregates.Percentage.average)#%)#} # &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span style='color:blue;'> Auditee:(Pending:  #=FilterData(value,'REJECTED')#%)</span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span style='color:green;'> Auditor:(Pending:  #=FilterData(value,'PENDING')#%)</span>" },
